...
//   late Function(List<String>)?
//   _connectedUsersCallback; // Callback cho thêm người dùng vào danh sách liên hệ
...
//     if (app != null) {
//       app.send("5", {"username": username}); // Gửi yêu cầu thêm người dùng
//     }
//   }
//
//   void printAllUsers() {
...
//     }));
//     appSetup.addDataHandler("5", _AddContactHandler((message) {
//       _addContactCallback!(message);
//     }));
//   }
//
...
//         .getAppByName("freechat");
//     if (app != null) {
//       app.send("5", {}); // Gửi yêu cầu lấy danh sách người dùng kết nối
//     } else {
//       print('Không thể tìm thấy ứng dụng "freechat".');
//     }
//   }
//
...
//
// //fetchUser-6
// class _ConnectedUsersHandler extends EzyAppDataHandler<Map> {
//   late Function(List<String>) _callback;
//
...
//     if (data.containsKey("connectedUsers") && data["connectedUsers"] is List) {
//       for (var user in data["connectedUsers"]) {
//         if (user is Map && user.containsKey("username")) {
//           connectedUsers.add(user["username"].toString());
//         }
//       }
//     } else {
//       print('Dữ liệu người dùng kết nối không hợp lệ.');
//     }
//     print('Danh sách người dùng kết nối từ server: $connectedUsers');
//     _callback(connectedUsers);
//   }
// }
//
