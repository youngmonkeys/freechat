...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Form _formUsernameAndPassword(LoginViewmodel loginController) {
    return Form(
  ...
  TextFormField _formPassword(LoginViewmodel loginController) {
  ...
  TextFormField _formUsername(LoginViewmodel loginController) {
    return TextFormField(
      controller: username,
      obscureText: false,
      textAlign: TextAlign.center,
